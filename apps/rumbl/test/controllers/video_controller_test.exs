defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "lists all user's videos on an index", %{conn: conn, user: user} do
    other_user  = insert_user(%{username: "other"})
    user_video  = insert_video(user, title: "funny cats")
    other_video = insert_video(other_user, title: "other video")
  ...
  @tag login_as: "max"
  test "authorizes actions by other users", %{conn: conn, user: owner} do
